    ...
    <section className="py-16 bg-blue-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <Card className="border-0 shadow-2xl" style={{ boxShadow: '0 10px 20px rgba(0, 0, 0, 0.5)' }}>
        ...
        <Card className="border-0 shadow-lg mt-20" style={{ boxShadow: '0 10px 20px rgba(0, 0, 0, 0.5)' }}>
          <CardContent className="pt-6">
